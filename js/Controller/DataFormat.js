define([], function() {
    ...
    function lnglat(lng, lat){
        ...
        lng = parseFloat(lng).toFixed(4);// ((parseFloat(lng) * 100) >> 0) / 100;
        lat = parseFloat(lat).toFixed(4);//((parseFloat(lat) * 100) >> 0) / 100;
        if((lng || lng == 0) 
                && (lat || lat == 0)) {
