...
define([], function() {
    ...
    function showRightMenu(){
        ...
        $('.rightPanel').hide();
        var rightPanelW = 550;
        $('.rightPanelWarp').stop().animate({'right':'0'},200);
    ...
    function hideRightMenu(){
        $('.rightPanelWarp').stop().animate({'right':'-550px'},200);
        ...
        //右上角模式切换位置
        $('#rightTopTab').stop().animate({'right':'40px'},200); 
    }
    ...
    function fenBianLv(){
        ...
        if(windowWidth <= 1300 || windowHeight < 800){
            $('#cloud_source_list').css({'left':'200px',' top':'100px'});//云图
            $('#radar_data_list').css({'left':'200px',' top':'320px'});//雷达
            $('.taiFeng1').css({'left':'300px',' top':'100px'});//台风
            $('.taiFeng2').css({'left':'300px',' top':'360px'});//台风
            $('.tides').css({'left':'300px',' top':'360px'});//潮汐
        }else{
            $('#cloud_source_list').css({'left':'450px',' top':'590px'});//云图
            $('#radar_data_list').css({'left':'150px',' top':'560px'});//雷达
            $('.taiFeng1').css({'left':'300px',' top':'250px'});//台风
            $('.taiFeng2').css({'left':'300px',' top':'520px'});//台风
            $('.tides').css({'left':'300px',' top':'520px'});//潮汐
        }
    }
